...
export default function WindSpeedPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8000/predict/speed', {
        method: 'POST',
        body: formDataToSend,
      });
      ...
      setHistoricalData(prev => [
        ...
        { 
          time: timestamp, 
          speed10m: data["Wind Speed at 10M"],
          speed50m: data["Wind Speed at 50M"]
        }
    ...
    datasets: [
      {
        ...
        data: historicalData.map(item => item.speed10m),
      ...
      },
      {
        ...
        data: historicalData.map(item => item.speed50m),
    ...
    <>
      ...
      <main className="min-h-screen pt-32 pb-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-800 mb-8">Wind Speed Prediction</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Temperature at 2 Meters (°C)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Specific Humidity at 2 Meters (g/kg)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Relative Humidity at 2 Meters (%)</label>
                <input
                  type="number"
            ...
            <div className="flex justify-center">
              ...
              >
                {loading ? 'Predicting...' : 'Predict Wind Speed'}
              </button>
            </div>
          </form>
            ...
            <div className="mt-6 p-4 bg-green-50 rounded-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-white rounded-md shadow">
                  <h3 className="font-medium text-gray-700">Wind Speed at 10M</h3>
                  <p className="text-2xl font-bold text-blue-600">{predictions["Wind Speed at 10M"].toFixed(2)} m/s</p>
                </div>
                <div className="p-4 bg-white rounded-md shadow">
                  <h3 className="font-medium text-gray-700">Wind Speed at 50M</h3>
                  <p className="text-2xl font-bold text-blue-600">{predictions["Wind Speed at 50M"].toFixed(2)} m/s</p>
                </div>
              </div>
            </div>
          )}
          ...
          {/* Wind Speed Chart */}
          <div className="mt-8">
            <h2 className="text-xl font-semibold mb-4">Wind Speed History</h2>
